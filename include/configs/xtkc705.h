...
/* Board and Processor */
/*=====================*/
#define CONFIG_XTAV200				/* Avnet LX200 board + Xtensa */
#define CONFIG_SYS_CLK_FREQ	(gd->cpu_clk)	/* FPGA CPU freq after init */
/* #define CONFIG_SYS_HZ_CLOCK	(gd->cpu_clk)      Input clock to NS16550 */
...
/* ASCII Display Info */
/*====================*/
#undef CONFIG_SYS_ASCDISP			/* Board has no ASCII display */
...
/* Flash & Environment */
/*=====================*/
/* XT-AV200 Flash has bottom block subdivided into 64x8KB parameter blocks */
...
#define CONFIG_SYS_FLASH_SIZE		0x8000000	/* flash size 128MB */
#define CONFIG_SYS_FLASH_SECT_SZ	0x20000		/* primary   block size 128KB */
#define CONFIG_SYS_FLASH_PARMSECT_SZ	0x8000		/* parameter block size  32KB */
...
#define CONFIG_SYS_FLASH_BASE		IOADDR(0x00000000)	/* flash uncached base addr */
...
#define CONFIG_HOSTNAME         "HiFi-2 Demo"
...
#define CONFIG_SYS_MEMORY_SIZE		0x08000000		/* 128 MB */
...
/*==============================*/
#define CONFIG_BOOTDELAY	10	/* enable autoboot after 20 seconds */
