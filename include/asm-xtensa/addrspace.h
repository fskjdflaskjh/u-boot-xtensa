...
#define CFG_IO_BASE		0xf0000000
#define CFG_MEMORY_BASE		0xd0000000

#define IOADDR(x)		(CFG_IO_BASE + (x))
#define MEMADDR(x)		(CFG_MEMORY_BASE + (x))
#define PHYSADDR(x)		((x) - CFG_MEMORY_BASE)
