...
#define OETH_TXBUFF_ADDR CFG_OETH_BUFF_ADDR
#define OETH_RXBUFF_ADDR (CFG_OETH_BUFF_ADDR + (OETH_TXBD_NUM*OETH_TX_BUFF_SIZE))
...
int eth_init(bd_t * bd)
{
  ...
  volatile oeth_regs * regs = (oeth_regs *) CFG_OETH_REG_BASE;
  ...
  tx_bd = (volatile oeth_bd *) CFG_OETH_BD_BASE;
  rx_bd = (volatile oeth_bd *) CFG_OETH_BD_BASE + OETH_TXBD_NUM;
